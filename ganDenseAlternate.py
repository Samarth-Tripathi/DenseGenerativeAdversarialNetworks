##### DOESNOT WORK. Another attempt at a dense connection with different kernel size
##### To accomodate for which, I used output padding to ensure same dimensionality, but generator loss doesnt converge.
##### checking in so no one else makes this mistake :-)
##### do not use output padding in Generators, only input padding!
