...
class GenTransition(nn.Module):
    def __init__(self, nChannels, nOutChannels):
        ...
        self.bn1 = nn.BatchNorm2d(nChannels)
        self.conv1 = nn.ConvTranspose2d(nChannels, nOutChannels, 4, 2, 1,
                               bias=False)
...
class GenDenseNet(nn.Module):
    def __init__(self, growthRate, depth, increase, nz, bottleneck=1, verbose=1):
        ...
        self.conv1 = nn.ConvTranspose2d(nz, growthRate*6 , kernel_size=3, padding=1,
                               bias=False)
        self.bn_1 = nn.BatchNorm2d(growthRate*6)
        
        nDenseBlocks = (depth-4) // 3
        if bottleneck:
            nDenseBlocks //= 2
        
        nChannels = growthRate*6
...
class DisTransition(nn.Module):
    def __init__(self, nChannels, nOutChannels):
        ...
        self.bn1 = nn.BatchNorm2d(nChannels)
        self.conv1 = nn.Conv2d(nChannels, nOutChannels, 4,2,1,
                               bias=False)
