#### gan.py converted to graph like Neural Architecture instead of NN.sequential architecture
#### intermediate file, but good to check whether architecture is working coreectly!
...
class _netD(nn.Module):
    ...
    def __init__(self, ngpu):
        ...
        self.conv5 = nn.Conv2d(ndf * 8, 1, 4, 2, 0, bias=False)
