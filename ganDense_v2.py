...
class _netG(nn.Module):
    def __init__(self, ngpu):
        ...
        self.pad1 = nn.ZeroPad2d((31,32,32,31))
        ...
        self.uconv5 =  nn.ConvTranspose2d(ngf + 100,     nc, 4, 2, 1, bias=False)
        self.ufinal = nn.Tanh()
...
class _netD(nn.Module):
    ...
    def __init__(self, ngpu):
        ...
        self.conv_plus = nn.Conv2d(ndf * 2, ndf * 4, 4, 0, 4, bias=False)
        ...
        self.conv5 = nn.Conv2d(ndf * 12, 1, 4, 1, 0, bias=False)
