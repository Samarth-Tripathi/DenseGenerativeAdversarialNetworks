...
#for labels 
#lab = torch.LongTensor(1, nclasses + 1).zero_()
...
for epoch in range(opt.niter):
    ...
    while i < len(dataloader):
        ...
        while j < Diters and i < len(dataloader):
            ...
            real_label = to_var(label)
	        #print(real_label)
	        #print(real_label.size(), "real label size")
            #fake_label = lab.scatter_(1, torch.LongTensor([[10]]), 1)
	        fake_label = torch.LongTensor([10])
	        #print(fake_label)
            fake_label = to_var(fake_label.expand(64,))
	        #print(fake_label.size(), "fake label size")
